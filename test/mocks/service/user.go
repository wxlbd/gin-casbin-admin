...
func (m *MockUserService) Register(ctx context.Context, req *v1.AddAdminUserRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAdminUser", ctx, req)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockUserServiceMockRecorder) Register(ctx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddAdminUser", reflect.TypeOf((*MockUserService)(nil).Register), ctx, req)
}
